                    ...
                    <ul class="nav-main">
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('dashboard') ? ' active' : '' }}" href="/dashboard">
                                ...
                                <span class="nav-main-link-name">Genel  Bakış</span>
                            </a>
                        </li>
                        <li class="nav-main-heading">Yayınlar</li>
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('broadCasting') ? ' active' : '' }}" href="/broadCasting">
                                <i class="nav-main-link-icon fa fa-house-user"></i>
                                <span class="nav-main-link-name">Bir Yayın Oluştur</span>
                            </a>
                        </li>
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                               aria-expanded="true" href="#">
                                <i class="nav-main-link-icon fa fa-plus-circle"></i>
                                <span class="nav-main-link-name">Birden Fazla  Yayın Oluştur</span>
                            </a>
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                               aria-expanded="true" href="#">
                            ...
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                               aria-expanded="true" href="#">
                                ...
                                <span class="nav-main-link-name">İstatistikler</span>
                            </a>
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                               aria-expanded="true" href="#">
                                <i class="nav-main-link-icon fa fa-volume-high"></i>
                                <span class="nav-main-link-name">Promosyonlar</span>
                            </a>
                        </li>
            ...
            <div class="space-x-1">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn btn-sm btn-alt-secondary" id="page-header-user-dropdown"
                        ...
                        <span class="d-none d-sm-inline-block fw-semibold">{{$user}}</span>
                        ...
                        <ul class="nav-items my-2 fs-sm">
                            ...
                            <li>
                                <a class="text-dark d-flex py-2" href="javascript:void(0)">
                                    ...
                                    <div class="flex-grow-1 pe-2">
                                        <p class="fw-medium mb-1">Please consider upgrading your plan. You are running
                                            out of space.</p>
        ...
        <div class="content py-3">
            <div class="row fs-sm">
                ...
                <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                    <a class="fw-semibold" href="https://1.envato.market/95j" target="_blank">Codebase</a> &copy; <span
